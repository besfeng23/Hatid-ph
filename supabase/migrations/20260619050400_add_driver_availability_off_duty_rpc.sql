create or replace function driver.set_my_driver_off_duty()
returns table (
  user_id uuid,
  vehicle_id uuid,
...
begin
  ...
  insert into driver.driver_availability as availability (user_id, availability_status)
  values (v_actor_user_id, 'offline')
