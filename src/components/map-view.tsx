    ...
    <div className="relative h-full w-full overflow-hidden rounded-2xl shadow-2xl shadow-black/50">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="relative flex flex-col items-center">
          <div className="absolute h-16 w-16 animate-ping rounded-full bg-accent/50" />
          <MapPin className="relative h-10 w-10 text-accent drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]" />
          <span className="relative mt-2 rounded-full bg-accent/80 px-2 py-1 text-xs font-bold text-accent-foreground">
            YOU ARE HERE
          </span>
        </div>
      </div>
